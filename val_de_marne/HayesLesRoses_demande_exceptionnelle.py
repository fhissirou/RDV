...
class Prefecture:
	...
	def updateSelenium(self, SUBJECT, TO):
		...
		while True:
			...
			try:
				url = "http://www.val-de-marne.gouv.fr/booking/create/9152"
				...
				time.sleep(1)
				python_button_demande = driver.find_elements_by_xpath("//input[@title='Cliquez ici pour effectuer une demande de rendez-vous']")[0]
			
				checkbox = driver.find_elements_by_xpath("//input[@id='condition']")[0]
				checkbox.click()
				time.sleep(1)
